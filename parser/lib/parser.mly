...
(**
    Файл описания грамматики для парсера, использующего menhir.
    Здесь определён синтаксис языка и правила для построения AST.
*)
...
%token CLASS INTERFACE PUBLIC PRIVATE PROTECTED STATIC ABSTRACT FINAL VOID
